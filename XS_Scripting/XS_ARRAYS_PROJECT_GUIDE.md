...
- `AI_Scripting/xs_arrays_full_project_demo.xs`
...
These were validated with your linter (`xs-check.exe`) in this repo.
...
Command used:
```bash
"C:\Users\user\Downloads\xs-check.exe" "C:\AoE2DE Modding\Code\AoE2_AI_Modder\AI_Scripting\xs_arrays_full_project_demo.xs"
```
