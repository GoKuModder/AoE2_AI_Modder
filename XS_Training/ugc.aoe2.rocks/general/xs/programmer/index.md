---
source_url: https://ugc.aoe2.rocks/general/xs/programmer/
fetched_at: 2026-02-08T19:30:22+00:00
---

For Programmers - AoE2DE UGC Guide
...
[Skip to content](#xs-scripting-a-programmers-reference)
...
* [XS Scripting](../)
  ...
  + For Programmers
    ...
    - [3. Operations](#3-operations)
      ...
      * [3.1. Arithmetic Operations](#31-arithmetic-operations)
      * [3.2. Prefix and Postfix Operations](#32-prefix-and-postfix-operations)
      * [3.3 Shorthand Assignment Operations](#33-shorthand-assignment-operations)
      * [3.4 Bitwise Operations](#34-bitwise-operations)
      * [3.5. Relational Operations](#35-relational-operations)
      * [3.6. Boolean Operations](#36-boolean-operations)
    - [4. Flow Control Statements](#4-flow-control-statements)
...
# XS Scripting: A Programmer's Reference[¶](#xs-scripting-a-programmers-reference "Permanent link")
...
## 2. Variables Data Types[¶](#2-variables-data-types "Permanent link")
...
2. Static Variables
   ...
   Syntax `static int counter = 0;` will declare a static variable.
3. Scope of a Variable

   The concept of local and global variables applies to XS.

## 3. Operations[¶](#3-operations "Permanent link")

### 3.1. Arithmetic Operations[¶](#31-arithmetic-operations "Permanent link")
...
### 3.2. Prefix and Postfix Operations[¶](#32-prefix-and-postfix-operations "Permanent link")
...
### 3.3 Shorthand Assignment Operations[¶](#33-shorthand-assignment-operations "Permanent link")

Shorthand Assignment operations are not supported by XS.

### 3.4 Bitwise Operations[¶](#34-bitwise-operations "Permanent link")

Bitwise operations are not supported by XS.

### 3.5. Relational Operations[¶](#35-relational-operations "Permanent link")
...
### 3.6. Boolean Operations[¶](#36-boolean-operations "Permanent link")
...
## 4. Flow Control Statements[¶](#4-flow-control-statements "Permanent link")
...
## 5. Functions[¶](#5-functions "Permanent link")
...
## 6. Arrays[¶](#6-arrays "Permanent link")
...
## 7. Type Casting[¶](#7-type-casting "Permanent link")
...
## 8. Rules[¶](#8-rules "Permanent link")
